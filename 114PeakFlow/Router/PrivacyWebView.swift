...
struct WKChromeAdapter: UIViewRepresentable {
    ...
    class NavigationRelay: NSObject, WKNavigationDelegate, WKUIDelegate {
        var parent: WKChromeAdapter
        private var failureCalled = false

        init(parent: WKChromeAdapter) {
            self.parent = parent
        }
        ...
        func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
            if let httpResponse = navigationResponse.response as? HTTPURLResponse {
                if FlowPreferenceLedger.shared.savedUrl == nil && !failureCalled {
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            ...
            if FlowPreferenceLedger.shared.savedUrl == nil {
                if let currentUrl = webView.url?.absoluteString {
                    FlowPreferenceLedger.shared.savedUrl = currentUrl
